...
namespace Searchable
{
    public class Function
    {
        ...
        private UrlModelStore<SearchableInputs> store;

        public async Task<SearchableOutputs> Handler(SearchableInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<SearchableInputs>();
            }
            

            var l = new InvocationWrapper<SearchableInputs,SearchableOutputs> (store, Searchable.Execute);
